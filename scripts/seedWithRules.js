...
const sampleUsers = [
  ...
  },
  {
    ...
    competences: [
      'Ruby', 'Ruby on Rails', 'PostgreSQL', 'Redis', 'Sidekiq', 'RSpec',
      'Git', 'Heroku', 'REST APIs', 'ActiveRecord', 'Devise'
    ]
  },
  {
    ...
    competences: [
      'Rust', 'WebAssembly', 'PostgreSQL', 'Actix-web', 'Tokio', 'Serde',
      'Git', 'Docker', 'Systems Programming', 'Performance Optimization'
    ]
  },
  {
    ...
    competences: [
      'Figma', 'Adobe XD', 'Sketch', 'UI/UX Design', 'Design Systems', 'Prototyping',
      'User Research', 'Accessibility (a11y)', 'Responsive Design', 'Design Thinking'
    ]
  },
  {
    ...
    ownerName: 'Noah Lee',
    competences: [
      'Terraform', 'Ansible', 'AWS', 'Kubernetes', 'Docker', 'Jenkins',
      'Prometheus', 'Grafana', 'Linux', 'Bash Scripting', 'Infrastructure as Code'
    ]
  },
  {
    ...
    competences: [
      ...
      'Stakeholder Management', 'Risk Assessment', 'Team Leadership', 'Product Strategy'
    ]
  }
]
...
async function seedDatabase() {
  ...
  try {
    ...
    for (let i = 0; i < sampleUsers.length; i++) {
      ...
      console.log(`✅ [${i + 1}/${sampleUsers.length}] Added user: ${user.ownerName} with ${competenceRows.length} competences`)
    }
