...
export default function CompetenceOverview() {
  ...
  const categoryFilteredCompetences =
  ...
  const levelFilteredCompetences =
            ...
            >
              ...
              >
                <Tooltip
                  title={
                    isTransposed
                      ? "Switch to show competences on left and users on top"
                      : "Switch to show users on left and competences on top"
                  }
                >
                  <IconButton
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <SwapHorizIcon
                              sx={{ fontSize: isMobile ? "18px" : "16px" }}
                            />
                          </IconButton>
                        </Tooltip>
                      </Box>
